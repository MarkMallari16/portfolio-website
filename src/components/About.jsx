    ...
    <div className='px-6 lg:px-0 pt-24 lg:pt-10 lg:mb-80  overflow-hidden'>
      <div className='grid grid-cols-1 lg:grid-cols-2 place-items-center mx-auto lg:gap-40'>
        ...
        <motion.div className='pt-8 lg:px-0 lg:pt-0 w-full'
          ...
          <button className='btn btn-outline btn-secondary mt-6 flex items-center justify-center py-3 px-5 text-white  rounded-lg transition duration-300' onClick={() => scrollIntoSection(contactRef)}>
