    ...
    <nav className={`mx-0 lg:mx-auto `}>
      <div className={` lg:px-0 flex flex-col lg:flex-row  lg:justify-between items-start lg:items-center lg:py-8`}>
        ...
        <motion.ul
          ...
          <li className='lg:tooltip  lg:tooltip-bottom' data-tip="Home">
            <a href='#home' className='flex gap-2 hover:text-secondary transition-all ease-in-out duration-300' onClick={() => scrollIntoSection(homeRef)} >

              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
                <path d="M11.47 3.841a.75.75 0 0 1 1.06 0l8.69 8.69a.75.75 0 1 0 1.06-1.061l-8.689-8.69a2.25 2.25 0 0 0-3.182 0l-8.69 8.69a.75.75 0 1 0 1.061 1.06l8.69-8.689Z" />
                <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a2.29 2.29 0 0 0 .091-.086L12 5.432Z" />
              </svg>
              <h1 className='text-4xl font-black lg:hidden'>Home</h1>
            </a>
          </li>
          <li className='lg:tooltip  lg:tooltip-bottom' data-tip="About">
            <a href='#about' className='flex gap-2 hover:text-secondary transition-all ease-in-out duration-300' onClick={() => scrollIntoSection(aboutRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
                <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" />
              </svg>
              <h1 className='text-4xl font-black lg:hidden'>About</h1>
            </a>
          </li>
          <li className='lg:tooltip  lg:tooltip-bottom' data-tip="Skills">
            <a href='#skills' className='flex gap-2 hover:text-secondary transition-all ease-in-out duration-300' onClick={() => scrollIntoSection(skillsRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
              ...
              <h1 className='text-4xl font-black lg:hidden'>Skills</h1>
            </a>
          </li>
          <li className='lg:tooltip  lg:tooltip-bottom' data-tip="Projects">
            <a href='#projects' className='flex gap-2 hover:text-secondary transition-all ease-in-out duration-300' onClick={() => scrollIntoSection(projectsRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
              ...
              <h1 className='text-4xl font-black lg:hidden'>Projects</h1>
            </a>

          </li>
          <li className='lg:tooltip  lg:tooltip-bottom' data-tip="Contact">

            <a href='#contacts' className='flex gap-2 hover:text-secondary transition-all ease-in-out duration-300' onClick={() => scrollIntoSection(contactRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
                <path d="M1.5 8.67v8.58a3 3 0 0 0 3 3h15a3 3 0 0 0 3-3V8.67l-8.928 5.493a3 3 0 0 1-3.144 0L1.5 8.67Z" />
                <path d="M22.5 6.908V6.75a3 3 0 0 0-3-3h-15a3 3 0 0 0-3 3v.158l9.714 5.978a1.5 1.5 0 0 0 1.572 0L22.5 6.908Z" />
              </svg>
              <h1 className='text-4xl font-black lg:hidden'>Contact</h1>
            </a>
          </li>
