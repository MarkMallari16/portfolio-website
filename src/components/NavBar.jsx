  ...
  return (
    <nav >
      <div className='navbar flex justify-between items-center py-5'>
        ...
        <div className={`lg:flex items-center gap-16 ${isMenuOpen ? 'flex' : 'hidden'}`} >
          <a href='#home' onClick={() => scrollIntoSection(homeRef)} className='border-b-2 p-3 border-secondary  rounded-lg '>
        ...
        <div className='hidden lg:block'>
          {theme === 'emerald' ? (
            ...
            >
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 cursor-pointer" onClick={toggleTheme}>
