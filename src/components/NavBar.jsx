    ...
    <nav className={`mx-0 lg:mx-auto`}>
      <div className={`navbar  lg:px-0 flex flex-col lg:flex-row  lg:justify-between items-start lg:items-center `}>
        ...
        <motion.ul
          ...
          <li>
            <motion.a href='#home' className='flex gap-2 hover:text-primary-content' onClick={() => scrollIntoSection(homeRef)} >
          ...
          <li className='padding-6px'>
            <a href='#about' className='flex gap-2' onClick={() => scrollIntoSection(aboutRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
          ...
          <li className='padding-6px'>
            <a href='#skills' className='flex gap-2' onClick={() => scrollIntoSection(skillsRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
          ...
          <li className='padding-6px'>
            <a href='#projects' className='flex gap-2' onClick={() => scrollIntoSection(projectsRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
          ...
          <li className='padding-6px'>
            ...
            <a href='#contacts' className='flex gap-2' onClick={() => scrollIntoSection(contactRef)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-10 lg:size-6">
